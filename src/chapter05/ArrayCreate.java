...
//		String[] fruits= {"바나나","사과","딸기",1,2,10};(x)
		...
		int[] scores= {83,90,87};
		System.out.println("socers[0]: "+scores[0]);
		System.out.println("socers[1]: "+scores[1]);
		System.out.println("socers[2]: "+scores[2]);
