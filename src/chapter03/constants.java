...
//		CONST_ASSIGNED=11;
		...
		//원을 다루는 코드
		final double PI_ORIGIN=3.14; //* final을 쓰면 변하지 않게 함
...
//		System.out.println(2200000000);
		...
		//정수형 상수의 언더바 삽입
//		int money=1,000,000;
		int money=1_000_000;       //*이렇게 하면 되지만 쓰진 않음
		System.out.println(money);
		//실수형 리터럴
		//double형 임을 명시하기 위해 d 또는 D삽입
		System.out.println(3.0004999D);
		//float형으로 표현하려면 f 또는 F삽입
		System.out.println(2.0004999f);
		//실수형 리터럴은 e표기법도 가능
		System.out.println(3.4e3); //*이렇게 하면 되지만 쓰진 않음
		//부울형 리터럴
		System.out.println(true);
		System.out.println(false);
		//문자형 리터럴 char          //* ''
		System.out.println('한');  //*2글자 이상 안됨
		//문자형 리터럴 String        //* ""
		System.out.println("한글"); //*2글자 이상
		
		//이스케이프 시퀀스(escape sequences)
		//화면상의 어떠한 상황 또는 상태를 표현하기 위해 약속된 문자
		// /-슬래시, \-백슬래시
		// \n - 개 행 문자
		System.out.println("Hellow World! I love java");
		...
		//이스케이프 시쿼스 \" - 큰따옴표 문자
		//""- 문자열의 리터럴 시작과 끝
		System.out.println("제임스 고슬링은 왈 \"새로운 일에 도전하는 것을 두려워하지 말고, 실패에 상관없이 계속 도전해야 한다\""); //* 문자열 그대로 받아드려 달라 \ 
		System.out.println("제임스 고슬링은 왈 \'새로운 일에 도전하는 것을 두려워하지 말고, 실패에 상관없이 계속 도전해야 한다\'"); //* 문자열 그대로 받아드려 달라 \
		// \t - 탭 문자
		System.out.println("1+1\t=2");
		System.out.println("11+11\t=22");
		// \ 백슬러시를 단순 문자로 사용하고 싶을 떄
		System.out.println("백슬러시(\\)는 키보드 엔터 위에 있습니다"); //* \\2번, 백슬러시(\)는 키보드 엔터 위에 있습니다
