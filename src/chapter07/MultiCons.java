...
public class MultiCons {
	...
	public MultiCons(String name, String phoneNString) {
		this.name=name;
		this.phoneNumber=phoneNumber;
	}

	@Override //* 우클릭 - source - toString
